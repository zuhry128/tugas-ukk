...
<div class="card shadow">
  ...
  <a href="?url=verifikasipengaduan" class="btn btn-primary btn-icon-split">
    <span class="icon text-white-50">
      <i class="fas fa-arrow-left"></i>
    </span>
    <span class="text">Kembail</span>
  </a>

  

  <div class="card-body">
    <form action="simpantanggapan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
