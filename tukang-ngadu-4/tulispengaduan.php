...
<div class="card shadow">
  ...
  <div class="card-body">
    <form action="simpanpengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
      <div class="form-group cols-sm-6">
       ...
       <div class="form-group cols-sm-6">
        ...
        <input type="file" name="foto" class="form-control" accept=".jpg, .jpeg, .png, .gif"><font color="red"> *tipe file yang bisa di upload adalah : .jpg, .jpeg, .png, .gif</font>
      </div>
